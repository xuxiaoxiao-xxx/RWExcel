...
public class SimpleExcelStreamListenerTest {
    ...
    public void testSimpleTitle() throws Exception {
        ExcelReader reader = new ExcelStreamReader();
        SimpleSheetListener<TestEntity> listener1 = new SimpleSheetListener<TestEntity>() {
            @Override
        ...
        SimpleSheetListener<TestEntity> listener2 = new SimpleSheetListener<TestEntity>() {
            @Override
            protected int titleRowCount() {
                return 2;
            }
    ...
    @Test
    public void testSimpleReadTwice() throws Exception {
        SimpleSheetListener<?> listener = new SimpleSheetListener<TestEntity>() {
        ...
        ExcelReader reader = new ExcelStreamReader();
        reader.read(Objects.requireNonNull(Thread.currentThread().getContextClassLoader().getResourceAsStream("testSimpleMismatch.xls")), listener);
        reader.read(Objects.requireNonNull(Thread.currentThread().getContextClassLoader().getResourceAsStream("testSimpleMismatch.xls")), listener);
    }
}